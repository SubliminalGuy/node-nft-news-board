...
exports.message_list = (req, res, next) => {
    Message.find({} )
        ...
        .exec((err, list_messages) => {
            ...
            res.render('index', {title: "NFT Gossip Board", message_list: list_messages, user: req.user})
        })
}
    ...
    (req, res, next) => {
        ...
        const errors = validationResult(req)
            ...
            var message = new Message(
                ...
                if (!errors.isEmpty()) {
                    res.render('messagepost', {title: "Post A Message", message: message, errors: errors.array()})
                    return;
                }
                else {
